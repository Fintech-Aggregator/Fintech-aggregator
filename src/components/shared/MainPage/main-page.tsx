      ...
      <div className="flex sm:hidden mt-8 flex-col justify-center items-center">
        <div className={cn(styles.text_bet, "text-center sm:text-left w-[clamp(15rem,_70vw,_25rem)]")}>
          ...
          <h2 className="text-[clamp(0.8rem,_2vw,_2rem)]">
            Our service enables users to efficiently access accurate and up-to-date information about fintech
            company licenses.
          </h2>
        </div>

        <button className={cn(styles.button, "w-[80%] my-8 !h-12 !text-lg")}>Find Licenses</button>
      </div>
